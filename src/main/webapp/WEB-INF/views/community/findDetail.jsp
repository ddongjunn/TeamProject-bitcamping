...
<div class="postpath">
	<span>
		...
		<a href="/community/findDetail.do?community_seq=${data.community_seq}" style="color: #75AE87;">${data.community_seq}</a>
	</span>
</div>
...
<div class="buttons_wrap" id="buttons_wrap">
	<c:if test="${login.id eq data.user_id }">
	   <form style="display: inline" name="updateFrm" action="/community/findUpdate.do?bbstype=find" method="POST">
	...
	<button type="button" class="btnSimple" onclick="location='/community/find.do'">목록</button>
</div>
