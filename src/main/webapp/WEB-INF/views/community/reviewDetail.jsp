...
<div class="buttons_wrap" id="buttons_wrap">
	<c:if test="${login.id eq data.user_id }">
	   <form style="display: inline" name="updateFrm" action="/community/reviewUpdate.do?bbstype=review" method="POST">
	...
	<button type="button" class="btnSimple" onclick="location='/community/review.do'">목록</button>
</div>
