...
<div class="communitybox">
    <div class="freebox_top">
    	<img src="../resources/images/deal.png" height="65px" width="90px">
...
$(document).ready(function () {
	...
	$("#pagination").twbsPagination({
		...
		onPageClick:function(event, page){
			location.href = "/community/find.do?choice=" + choice + "&search=" + search + "&pageNumber=" + (page - 1);
		}
	});
 	// 검색
	$("#btnSearch").click(function () {
		...
		location.href = "/community/find.do?choice=" + $("#_choice").val() + "&search=" + $("#_search").val();
	});  
});
</script>
