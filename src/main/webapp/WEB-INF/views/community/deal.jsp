...
<a href="/community/deal.do?bbstype=${data.bbstype}">전체글</a>
<a href="/community/deal.do?bbstype=${data.bbstype}">삽니다</a>
<a href="/community/deal.do?bbstype=${data.bbstype}">팝니다</a>
<a href="/community/deal.do?bbstype=${data.bbstype}">거래완료</a>
...
$(document).ready(function () {
	...
	$("#pagination").twbsPagination({
		...
		onPageClick:function(event, page){
			location.href = "/community/deal.do?choice=" + choice + "&search=" + search + "&pageNumber=" + (page - 1);
		}
	});
 	// 검색
	$("#btnSearch").click(function () {
		...
		location.href = "/community/deal.do?choice=" + $("#_choice").val() + "&search=" + $("#_search").val();
	});  
});
</script>
