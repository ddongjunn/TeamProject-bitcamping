...
<form name="regi_frm" method="post" action="/rent/regiAf.do" enctype="multipart/form-data" autocomplete="off">
  <h1>상품 등록</h1>
  <div class="question">
  ...
  <div class="question">
    ...
    <div class="question">
    <input type="text" name="product_Stock" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength="8" autocomplete="off" required />
    <label>재고(개)</label>
  </div>
  <div class="borderbox">
