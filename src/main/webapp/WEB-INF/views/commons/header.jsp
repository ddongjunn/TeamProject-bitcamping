                ...
                <div class="modal_login">
                    ...
                    <div class="modal_login_sns">
                        <form style="display: inline" action="/login/naver.do" method="post">
                            <button class='btn-social-login' style='background:#1FC700'><i class="xi-3x xi-naver"></i>
                            </button>
                        </form>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <form style="display: inline" action="javascript:void(0)">
                            <button class='btn-social-login' style='background:#D93025'><i class="xi-3x xi-google"></i>
                            </button>
                        </form>
                    </div>
