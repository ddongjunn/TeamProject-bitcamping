    ...
    $(document).ready(function () {
        ...
        $("#pagination").twbsPagination({
            ...
            onPageClick: function(event,page){
                location.href = "/admin/camping-review.do?" + "pageNumber=" + (page - 1) + "&choice=" + choice + "&search=" + search;
            }
        });
        ...
        $("#btnSearch").click(function () {
            ...
            location.href = "/admin/camping-review.do?" + "choice=" + $("#_choice").val() + "&search=" + $("#_search").val();
        });
    });
</script>
</body>
