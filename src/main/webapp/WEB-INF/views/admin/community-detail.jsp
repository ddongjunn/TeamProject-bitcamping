    ...
    <table class="tabledetail">
        ...
        <tr>
            <td class="detailinfo">
                ...
                <span>조회수 ${community.readcount}</span>
                <hr>
            </td>
        </tr>
        <tr>
            <td class="detailcontent">
                <span id="text">${community.content}</span>
            </td>
        </tr>
        </tbody>
    </table>
...
<script type="text/javascript">
    ...
    function del(community_seq){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                location='/admin/community-delete.do?community_seq=' + ${community.community_seq};
    ...
    $("#addComment").on("click", function(){
        var user_id;
        var community_seq = "${community.community_seq}"; // 글번호
        ...
        if(${login == null}) {
            ...
            $.ajax({
                url : "/admin/community-writeComment.do",
                type : "POST",
    ...
    function commentList(pageNumber) {
        ...
        $.ajax({
            url : "/admin/community-commentList.do",
            type : "POST",
    ...
    function commentAnswer(comment_seq){
        ...
        if(${login == null}) {
            ...
            $.ajax({
                url : "/admin/community-answerComment.do",
                type : "POST",
                data : {"content" : content,
                    "community_seq" : community_seq,
                    "user_id" : user_id,
    ...
    function commentUpdate(comment_seq){
        ...
        $.ajax({
            url : "/admin/community-updateComment.do",
            type : "POST",
            data : {"content" : content,
                "comment_seq" : comment_seq},
            success : function(result){
        ...
        if(${login == null}) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url : "/admin/community-deleteComment.do",
                        type : "POST",
